        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li>
                <Link to="/login" className="text-sm text-slate-400 hover:text-gold-400 transition-colors">
              ...
              <li>
                <Link to="/verify" className="text-sm text-slate-400 hover:text-gold-400 transition-colors">
                  {t.footer.verifyCertificate}
                </Link>
              </li>
              <li>
                <Link to="/marketplace" className="text-sm text-slate-400 hover:text-gold-400 transition-colors">
