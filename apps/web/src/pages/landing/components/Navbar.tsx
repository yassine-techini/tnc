        ...
        {menuOpen && (
          <div className="md:hidden border-t border-slate-800/50 py-4 space-y-3">
            ...
            <div className="pt-3 border-t border-slate-800/50 space-y-2">
              <Link to="/login" className="block text-center px-4 py-2.5 text-sm text-slate-300 hover:text-gold-400 transition-colors">
                {t.nav.login}
              </Link>
              <Link to="/register" className="block text-center px-4 py-2.5 text-sm font-semibold bg-gradient-to-r from-gold-500 to-gold-600 text-slate-950 rounded-xl">
                {t.nav.createAccount}
              </Link>
            </div>
          </div>
